...
# Form implementation generated from reading ui file '.\ui\decryptUsersDialog.ui'
#
...
if __name__ == "__main__":
    ...
    decryptUsersDialog = QtWidgets.QDialog()
    ui = Ui_decryptUsersDialog()
    ui.setupUi(decryptUsersDialog)
    decryptUsersDialog.show()
    sys.exit(app.exec_())
